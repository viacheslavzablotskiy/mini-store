import { Controller, Delete, Get, Param, Patch, Post, Query, Req, UseFilters, UseGuards, Body, ParseIntPipe, DefaultValuePipe } from "@nestjs/common";
...
export class ProductController {
    ...
    async getPosts(
        ...
        @Query('category') category?: Category): Promise<Product[]> {
        return this.productService.getProducts(category, Number(lastId))
    }
